...
export const PERT = () => {
    ...
    const { getActividad, activity_format, cal_pert_route, generate_diagram } = useCriticalRoute()
    ...
    const onSubmit = handleSubmit(values => {
        ...
        const results = cal_pert_route(data, setting?.tipo)
    ...
    return (
        <div className="flex flex-col items-center justify-center  bg-gray-50">
            <Link to={'/'}>
                <h1 className="text-3xl font-bold mb-8 mt-6 text-gray-700">Técnica de evaluación y revisión de programas (PERT)</h1>
            </Link>
                                    ...
                                    <table className="bg-white">
                                        <thead className="bg-gray-50 border-b-2 border-gray-200">
                                            <tr className="divide-x divide-gray-200 text-center">
                                                ...
                                                {setting?.tipo === '2' && (
                                                    <>
                                                        <th className="tracking-wide p-2">Tiempo optimista</th>
                                                        <th className="tracking-wide p-2">Tiempo medio</th>
                                                        <th className="tracking-wide p-2">Tiempo pesimista</th>
                                                    </>
                                                )}
                                            </tr>
                                        </thead>
                                            ...
                                            {Array.from({ length: setting?.num_actividades }).map((_, index) => (
                                                ...
                                                >
                                                    ...
                                                    {setting?.tipo === '2' && (
                                                        <>
                                                            <td>
                                                                <input type="text" className="px-2 text-center" {...register(`tiempoOptimista${index + 1}`)} />
                                                            </td>
                                                            <td >
                                                                <input type="text" className="px-2 text-center" {...register(`tiempoMedio${index + 1}`)} />
                                                            </td>
                                                            <td >
                                                                <input type="text" className="px-2 text-center" {...register(`tiempoPesimista${index + 1}`)} />
                                                            </td>
                                                        </>
                                                    )}
                                                    {setting?.tipo === '1' && (
                                                    ...
                                                    <table className="bg-white">
                                                        <thead className="bg-gray-50 border-b-2 border-gray-200">
                                                            <tr className="divide-x divide-gray-200 text-center">
                                                                ...
                                                                <th className="tracking-wide p-2">Tiempo Esperado</th>
                                                                <th className="tracking-wide p-2">Varianza</th>
                                                                <th className="tracking-wide p-2">Desviación Estándar</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody className="divide-y divide-gray-200">
                                                            {result.map((task, i) => (
                                                                ...
                                                                >
                                                                    ...
                                                                    {
                                                                        i === 0 ?
                                                                            <td className="whitespace-nowrap p-2 text-center" rowSpan={result.length} >
                                                                                {result.totalStandardDeviation}
                                                                            </td> : ''
                                                                    }
